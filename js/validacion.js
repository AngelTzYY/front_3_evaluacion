...
function validar_comuna() {
    ...
    if (comuna === "") {
        ...
        checkValidIconComuna.innerHTML = "<i class='fas fa-times text-danger'></i>"; 
        return false;
    } else {
        errorComuna.style.display = "none";
        checkValidIconComuna.innerHTML = "<i class='fas fa-check text-success'></i>";
        return true;
    }
}
...
function validar_paginaWeb() {
    ...
    var checkValidIconPaginaWeb = document.getElementById('checkValidIconPaginaWeb');
    ...
    if (isValid) {
        ...
        checkValidIconPaginaWeb.innerHTML = "<i class='fas fa-check text-success'></i>"; 
    } else {
        input.classList.add('is-invalid');
        error.style.display = 'block';
        checkValidIconPaginaWeb.innerHTML = "<i class='fas fa-times text-danger'></i>"; 
    }
}
...
function validar_contraseña() {
    ...
    var checkValidIcon = document.getElementById("checkValidIcon");
    ...
    if (password === "") {
        ...
        checkValidIcon.className = "fas fa-times text-danger";
    ...
    if (confirmPassword.value !== "") {
        if (password !== confirmPassword.value) {
            ...
            errorMessageConfirmPassword.style.display = "none";
            checkValidIcon.className = "fas fa-check text-success";
            return true;
        }
    }
...
function validar_correo() {
    ...
    var checkValidIconCorreo = document.getElementById("checkValidIconCorreo");
    ...
    if (correo === "") {
        ...
        checkValidIconCorreo.className = "fas fa-times text-danger";
        return false;
    } else {
        ...
        if (pos_arroba > 0 && pos_punto > pos_arroba + 1 && pos_punto < correo.length - 1 && extension.length >= 2 && extension.length <= 3) {
            ...
            checkValidIconCorreo.className = "fas fa-check text-success";
            return true;
        } else {
            div_error_email.style.display = "block";
...
function validar_direccion() {
    ...
    var checkValidIconDireccion = document.getElementById("checkValidIconDireccion");

    if (direccion == "") {
        div_error_direccion.innerHTML = "Campo obligatorio";
        div_error_direccion.className = "text-danger small mt-1";
        checkValidIconDireccion.innerHTML = "<i class='fas fa-times text-danger'></i>"; 
        return false;
    } else {
        div_error_direccion.innerHTML = "";
        checkValidIconDireccion.innerHTML = "<i class='fas fa-check text-success'></i>"; 
        return true;
    }
}
...
function validar_telefono() {
    ...
    const checkValidIconTelefono = document.getElementById('checkValidIconTelefono');
    ...
    if (!esNumero(phoneInput.value)) {
        ...
        checkValidIconTelefono.innerHTML = "<i class='fas fa-times text-danger'></i>"; 
        return false; 
    }
    ...
    checkValidIconTelefono.innerHTML = "<i class='fas fa-check text-success'></i>";
    return true;
}
